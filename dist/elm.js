		...
		switch (msg.$) {
			...
			case 'GetFromLocalStorageResp':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{localStorageFormValue: newValue, waitingForJs: false}),
					$elm$core$Platform$Cmd$none);
...
var $author$project$Main$ClearLocalStorage = {$: 'ClearLocalStorage'};
var $author$project$Main$GetFromLocalStorageReq = {$: 'GetFromLocalStorageReq'};
var $author$project$Main$SetToLocalStorage = {$: 'SetToLocalStorage'};
var $author$project$Main$UpdLocalStorageFormKey = function (a) {
	return {$: 'UpdLocalStorageFormKey', a: a};
};
